...
CScene6::CScene6()
{
	...
	pTextures->CreateTextureAnisotropic(0, "../Scene1/brick.bmp");
	pTextures->CreateTextureAnisotropic(1, "../Scene1/grafite.bmp");
...
int CScene6::DrawGLScene(void)	// Função que desenha a cena
{
	...
	glBlendFunc(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA); // Configura os parâmetros S e D
